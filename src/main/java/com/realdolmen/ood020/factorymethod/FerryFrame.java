...
public class FerryFrame extends JFrame implements ActionListener {
	...
	private FactoryVehicleCreator fc  = new FerryType622ConcreteVehicleCreator();
	...
	public void actionPerformed(ActionEvent event) {
		if (event.getSource() == newVehicle) {
			...
			*/  //wat in commentaar staat wordt weggedaan door 1 regel ervoor en 2 daarna m.b.v. factory design pattern.
			v = fc.createVehicle(checkboxes[0].isSelected(),noPass, reg, berths);
			added = theFerry.addVehicle(v);
