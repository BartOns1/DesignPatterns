...
public class AgeSlider extends JFrame implements ActionListener, Observer// , Observer
{
	...
	public AgeSlider(String title, Person p) {
		...
		aperson = p;
		aperson.addObserver(this);//Deze lijn legt de verbinding tussen observer en subject
